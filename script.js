(function () {
  ...
  /* =========================================================
   * aivoropro.com — client application
   * Real Mail.tm API integration, no fake data.
   * ========================================================= */

  var POLL_INTERVAL = 15000;
  var STORAGE_SESSION = "aivoropro-session";
  var STORAGE_THEME = "aivoropro-theme";
  ...
  function init() {
    ...
    document.querySelectorAll('a[data-footer-link="terms"]').forEach(function (a) {
      a.addEventListener("click", function (e) {
        e.preventDefault();
        toast("aivoropro.com is provided as-is for temporary email use. See the Mail.tm terms: https://mail.tm/", "info");
      });
    });
